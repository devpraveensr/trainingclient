...
// import * as UserActions from '../actions/trainingActions';
        ...
        tableFields.forEach(fld => {
          switch(fld) {
            ...
            case 'Action':
              ...
              //     text: '',
              //     icon: 'fa fa-edit',
              //     onclick: () => {this.props.onAction('edit', dtIndex, `${dt.id}`)}
              //   },
              //   {
              //     id: 'delete',
              //     type: 'delete',
              ...
              //     text: '',
              //     icon: 'fa fa-trash',
              //     onclick: () => {this.props.onAction('delete', dtIndex, `${dt.id}`)}
              //   }
              // ];
            ...
            default:
              ...
              dataObj[`${fld}`] = dt[`${fld.toLowerCase()}`];
              break;
          }
